...
If any of the information defined as requiring cryptographic protection from modification is not encrypted in a manner that provides the required level of protection, this is a finding.'
  ...
  # OVERLAY-ADDED (MANUAL-REVIEW, overlay #6): upstream shipped this as an empty stub
  # (silent pass). Marked as an explicit review so it can never silently pass.
  describe 'cryptographic protection of data at rest is a config/policy review' do
    skip 'cryptographic protection of data at rest is a config/policy review'
  end
end
