...
include_controls 'oracle-database-19c-stig-baseline' do
  ...
  # cleartext 1521 path (terraform-provision#2361). Restriction of ports/protocols/services
  ...
  control 'SV-270558' do
    ...
    desc 'Not Applicable on managed AWS RDS. The DISA check is ' \
         ...
         'denying the cleartext 1521 path (terraform-provision#2361). Restriction of ' \
    ...
    describe 'SV-270558 (restrict functions/ports/protocols/services, PPSM CAL, ' \
      ...
      skip 'Not Applicable (not_applicable_rds): the check inspects the ' \
           ...
           '(terraform-provision#2361). See control-layers.yml and docs/RESPONSIBILITY.md.'
    end
  end
