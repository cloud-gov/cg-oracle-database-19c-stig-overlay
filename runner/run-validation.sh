...
# emit per-control pass/fail/skip/error + a summary. As more controls are
# dispositioned (#3) this summary becomes the coverage report referenced by #6.
#
...
# Summarize per-status from the JSON.
